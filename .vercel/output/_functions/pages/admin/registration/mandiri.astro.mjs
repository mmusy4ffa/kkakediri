...
<\/script>`])), renderComponent($$result, "AdminLayout", $$AdminLayout, { "title": "Pendaftaran Mandiri" }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="mb-8 flex items-center justify-between"> <div> <h1 class="text-3xl font-bold">Pendaftaran Mandiri</h1> <p class="mt-2 text-slate-500">Kelola halaman pendaftaran mandiri.</p> </div> <a href="/admin/registration/mandiri/create" class="rounded-xl bg-blue-600 px-5 py-3 text-white hover:bg-blue-700">
Tambah
...
Hapus
</button> </div> </td> </tr>`)} </tbody> </table> ${items?.length === 0 && renderTemplate`<div class="p-8 text-center text-slate-500">Belum ada data pendaftaran mandiri.</div>`} </div> ` }));
}, "D:/Magang Industri/ProjectKKA3/kkakediri/src/pages/admin/registration/mandiri.astro", void 0);

const $$file = "D:/Magang Industri/ProjectKKA3/kkakediri/src/pages/admin/registration/mandiri.astro";
const $$url = "/admin/registration/mandiri";
